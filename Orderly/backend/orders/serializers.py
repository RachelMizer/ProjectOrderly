...
class BusinessOrderListSerializer(serializers.ModelSerializer):
    """
    Serializer for business-facing order list results.
...
class CompleteOrderResponseSerializer(serializers.ModelSerializer):
    """
    Serializer for successful order completion response.
