...
class VariantInventoryUsage(models.Model):
    ...
    def __str__(self) -> str:
        return f"{self.variant} uses {self.quantity_used} {self.inventory_item.unit_of_measure} {self.inventory_item.name}"
...
class ModifierInventoryUsage(models.Model):
    ...
    def __str__(self) -> str:
        return f"{self.modifier_option} uses {self.quantity_used} {self.inventory_item.unit_of_measure} {self.inventory_item.name}"
